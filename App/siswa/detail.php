         ...
         <main>
            <div class="container-fluid px-3">
               <ol class="breadcrumb mb-4 mt-2">
                  <li class="breadcrumb-item active"><a href="riwayat-peminjaman.php" style="text-decoration: none;">Riwayat Peminjaman</a> > Detail Buku</li>
               </ol>
               ...
               ?>
               <img src="./../admin/images/<?php echo $p['gambar_buku'] ?>" alt="">
               <table class="mt-3">
                <tbody>
