            ...
            <div class="container-fluid px-3">
               ...
               <div class="">
                  <section id="minimal-statistics">
                     <div class="row bg-light pt-2 pb-1" style="text-align: center;">
                        <div class="col-md-4">
                           <a href="peminjaman.php" style="text-decoration: none; color: #000">
                              <div class="card card-body p-2 shadow-sm">
                                 <img src="../icons/book.svg" style="border-radius: 3px; height:90px;">
                                 <p class="huruf-kecil">Peminjaman</p>
                              </div>
                           </a>
                        </div>
                        <div class="col-md-4">
                           <a href="riwayat-peminjaman.php" style="text-decoration: none; color: #000">
                              <div class="card card-body p-2 shadow-sm">
                                 <img src="../icons/history.svg" style="border-radius: 3px; height:90px;">
                                 <p class="huruf-kecil">Riwayat Peminjaman</p>
                              </div>
                           </a>
                        </div>
                        <div class="col-md-4">
                           <a href="logout.php" style="text-decoration: none; color: #000">
                              <div class="card card-body p-2 shadow-sm">
                                 <img src="../icons/logout.svg" style="border-radius: 3px; height:90px;">
                                 <p class="huruf-kecil">Log Out</p>
                              </div>
                           </a>
                        </div>
                     </div>
